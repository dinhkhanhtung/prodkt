...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    _sellPriceController = TextEditingController(text: StringUtils.formatNumber(widget.product.sellPrice));
    _costPriceController = TextEditingController(text: StringUtils.formatNumber(widget.product.costPrice));
    ...
    try {
      ...
      if (success) {
        ...
        if (mounted) {
          DialogHelper.showErrorToast(
            context: context,
            message: 'Không thể cập nhật sản phẩm: ${productProvider.error}',
          );
        }
      }
    } catch (e) {
